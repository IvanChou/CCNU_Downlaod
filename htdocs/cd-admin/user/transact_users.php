...
if (isset($_REQUEST['action'])) {
    ...
    case '添加':
		...
		if($admin_pass1==$admin_pass2){
		    ...
		    header("content-type:text/html; charset=utf-8");
			echo "<script language='javascript'>alert('两次输入的密码不一致！');location.href='../index.php?title=users&list=add';</script>";
		}
        break;
    ...
    case 'del':
		...
		if($_SESSION['USERNAME'] =='cd-admin'&& $ID != 1){
		    ...
		    header("content-type:text/html; charset=utf-8");
			echo "<script language='javascript'>alert('删除无效！');location.href='../index.php?title=users&list=view';</script>";
		}
        break;
